defmodule DoctorSchedule.Appointments.Services.MonthAvailabilityServiceTest do
  ...
  test "it should see all available month with schedules" do
    ...
    with_mocks [
      {Date, [:passthrough], [utc_today: fn -> ~D[2021-10-13] end]}
    ] do
      create_appointment_list(provider.id, user.id)

      response = MonthAvailabilityService.execute(provider.id, 2021, 10)
  ...
  defp date_list do
    [
      ~N[2021-10-14 09:00:00],
      ~N[2021-10-14 08:00:00],
      ~N[2021-10-14 10:00:00],
      ~N[2021-10-14 11:00:00],
      ~N[2021-10-14 12:00:00],
      ~N[2021-10-14 13:00:00],
      ~N[2021-10-14 14:00:00],
      ~N[2021-10-14 15:00:00],
      ~N[2021-10-14 16:00:00],
      ~N[2021-10-14 17:00:00],
      ~N[2021-10-14 18:00:00],
      ~N[2021-10-14 19:00:00],
      ~N[2021-10-14 20:00:00]
    ]
  end
end
